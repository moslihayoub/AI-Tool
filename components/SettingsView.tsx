...
export const SettingsView: React.FC<SettingsViewProps> = ({ theme, setTheme, onLoadDummyData, isDummyDataButtonDisabled, onOpenQuotaModal, isOwner, onDisconnect, isDummyDataActive, onReset }) => {
    ...
    return (
        <div className="p-4 sm:p-8 space-y-8">
            <header>
                <h2 className="text-3xl font-bold font-display text-gray-800 dark:text-gray-100">{t('settings.title')}</h2>
            ...
            <div className="max-w-md space-y-6">
                ...
                <div className="bg-white dark:bg-gray-800 p-6 rounded-xl border dark:border-gray-700">
                    {isOwner ? (
                        <>
                            <h3 className="text-lg font-semibold font-display mb-3">{t('settings.connection.title_connected')}</h3>
                        ...
                        <>
                            <h3 className="text-lg font-semibold font-display mb-3">{t('settings.connection.title')}</h3>
